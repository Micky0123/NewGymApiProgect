...
//        public List<List<ExerciseDTO>> exercisePlan1 { get; set; }
//    }
...
//        private const string SumOfSmallByTimeSheet = "SumOfSmallByTime"; 
//        private const string CategorySheet = "Category";
//        private const string TimeCategorySheet = "Time";
...
//        public async Task<List<List<ExerciseDTO>>> AddProgramExerciseAsync(ProgramExerciseDTO programExercise, int daysInWeek, int goal, int level, int time)
//        {
//            //לא קבוע
...
//            // Filter rows where column 1 matches the provided goal
//            var matchingRows = worksheet.RowsUsed()
//                .Where(row => row.Cell(1).GetValue<int>() == goal)
//                .ToList();
